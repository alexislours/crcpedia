Ninji's exports: [HTML](https://wuffs.org/acnh/bcsv_160/html/ItemFrom.html), [CSV](https://wuffs.org/acnh/bcsv_160/csv/ItemFrom.csv), [JSON](https://wuffs.org/acnh/bcsv_160/json/ItemFrom.json)
...
| 0 | 207 | 'MileExchangeReaction' | 'マイル交換_リアクション(買い切り)' | 
| 0 | 67 | 'Bridge' | '案内所_橋' | 
| 0 | 68 | 'Slope' | '案内所_坂' | 
...
| 201 | 146 | 'SummerSolstice' | '<リージョン>夏至' | 
...
| 201 | 157 | 'NewYearDay' | '<リージョン>お正月（日本１）' | 
| 201 | 168 | 'WinterSolstice_Southern' | '<リージョン>冬至' | 
| 201 | 186 | 'AsiaStarFestival' | '<リージョン>牛郎織女の日' | 
| 201 | 196 | 'NewYearEve' | '<リージョン>大晦日' | 
| 201 | 199 | 'NewYearsEveGermany' | '<リージョン>NewYearsEve（ドイツ）' | 
| 201 | 200 | 'NewYearsEveSpain' | '<リージョン>NewYearsEve（スペイン）' | 
| 201 | 201 | 'NewYearsEveWorld' | '<リージョン>NewYearsEve（ワールド）' | 
| 201 | 202 | 'NewYearDay2' | '<リージョン>お正月（日本２）' | 
| 201 | 203 | 'NewYearRoshia' | '<リージョン>お正月（ロシア）' | 
| 201 | 204 | 'NewYearWorld' | '<リージョン>お正月（ワールド）' | 
| 201 | 205 | 'NewYearKorea' | '<リージョン>お正月（韓国）' | 
| 201 | 206 | 'NewYearChina' | '<リージョン>お正月（アジア）' | 
| 201 | 210 | 'NeyYearDay3' | '<リージョン>お正月（日本３）' | 
...
| 231 | 193 | 'Harvest' | 'ハーベスト_家具' | 
| 351 | 194 | 'Harvest_tuk' | 'ハーベスト_フランクリン' | 
| 0 | 195 | 'Harvest_RecipeBook' | '店_ハーベストレシピ本' | 
| 231 | 198 | 'Christmas_ShopLv2' | '店_店舗大クリスマス' | 
| 351 | 211 | 'Christmas_NPC' | 'クリスマス_NPC' | 
