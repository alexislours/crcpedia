Ninji's exports: [HTML](https://wuffs.org/acnh/bcsv_160/html/ItemMenuIcon.html), [CSV](https://wuffs.org/acnh/bcsv_160/csv/ItemMenuIcon.csv), [JSON](https://wuffs.org/acnh/bcsv_160/json/ItemMenuIcon.json)
...
| 734 | 'SmartphoneCaseComp' | 'ポケットキャンプスマホ' | 'SmartphoneCaseComp' | 
...
| 731 | 'WPaperOrnament' | 'ラッピングペーパー：オーナメント' | 'WPaperOrnament' | 
| 730 | 'WBagOrnament' | 'ラッピング袋：オーナメント' | 'WBagOrnament' | 
...
| 365 | 'SparklingSoda' | 'スパークリングサイダー' | 'SparklingSoda' | 
...
| 372 | 'SantaSack' | 'プレゼントぶくろ' | 'SantaSack' | 
